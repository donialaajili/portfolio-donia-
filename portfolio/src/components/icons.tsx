...
export const AngularIcon = ({ className }: IconType) => (
  <svg className={className} viewBox="0 0 250 250" fill="currentColor">
    <path d="M124.8 0L0 44.3l19 151.3 105.8 61 105.7-61 19-151.3L124.8 0zM124.9 22.5l87.2 31.3-13.6 117.1-73.6 42.5-73.6-42.5L37.7 53.8 124.9 22.5zm-.3 29.8L74.3 153h24.3l10.5-24.5h48.2l10.5 24.5h24.3l-50.3-100.7h-20.2zm10.2 24.6 16.7 33.3h-33.4l16.7-33.3z" />
  </svg>
);
...
export const VuetifyIcon = ({ className }: IconType) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2L1 21h9l2-3.5L15 21h9L12 2z" />
  </svg>
);

export const CppIcon = ({ className }: IconType) => (
  <svg className={className} viewBox="0 0 512 512" fill="currentColor">
    <path d="M256 0L512 128v256L256 512 0 384V128L256 0zM256 472l216-124V164L256 40 40 164v184l216 124zm-30-230h-42v28h42v42h28v-42h42v-28h-42v-42h-28v42z" />
  </svg>
);

export const JavaIcon = ({ className }: IconType) => (
  <svg className={className} viewBox="0 0 64 64" fill="currentColor">
    ...
    <path d="M36 45c2 0 5-2 5-5s-3-5-5-5-5 2-5 5 3 5 5 5z" />
    <path d="M28 30h8v-6h-8v6z" />
  </svg>
);

export const BashIcon = ({ className }: IconType) => (
  <svg className={className} viewBox="0 0 48 48" fill="currentColor">
    <path d="M4 8v32h40V8H4zm2 2h36v28H6V10zm5 5v2h2v-2h-2zm0 4v2h4v-2h-4zm0 4v2h6v-2h-6z" />
  </svg>
);
