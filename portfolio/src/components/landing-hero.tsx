        ...
        <div className="mx-auto max-w-7xl">
          <AnimatePresence>
            ...
            <FadeUp key="description" duration={0.6} delay={0.2}>
              ...
              I'm a computer science student with a focus on cybersecurity. I'm aiming to specialize in either penetration testing or working within a Security Operations Center (SOC). I have hands-on experience building mobile apps, web applications, Skilled in{" "}
                ...
                <span className="font-semibold text-accent">CSS</span>, and desktop software.
              </div>
            </FadeUp>
          </AnimatePresence>
        </div>
